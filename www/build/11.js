...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__special_detail__ = __webpack_require__(408);
...
SpecialDetailPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-special-detail',template:/*ion-inline-start:"/Users/sumail/Downloads/bomao-app/src/pages/special/special-detail/special-detail.html"*/'<ion-header>\n  <ion-navbar>\n    <button icon-only class="fr">\n      <mores></mores>\n    </button>\n    <ion-title>优惠活动</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding class="white-bg">\n  <h1 class="special-title">{{params.get(\'detail\').name}}</h1>\n  <div class="help-wrap" [innerHtml]="params.get(\'detail\').content"></div>\n</ion-content>\n'/*ion-inline-end:"/Users/sumail/Downloads/bomao-app/src/pages/special/special-detail/special-detail.html"*/,
    }),
