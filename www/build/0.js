...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SaibaoPageModule", function() { return SaibaoPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__saibao__ = __webpack_require__(380);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sub_business_tool__ = __webpack_require__(359);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__subCameconfigServiceProvider__ = __webpack_require__(364);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_service_games_gameconfig_service_gameconfig_service__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_service_games_basket_service_basket_service__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_tools_business_tool__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_components_module__ = __webpack_require__(346);
...
var SaibaoPageModule = (function () {
    function SaibaoPageModule() {
    }
    return SaibaoPageModule;
}());
SaibaoPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__saibao__["a" /* SaibaoPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_8__components_components_module__["a" /* ComponentsModule */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__saibao__["a" /* SaibaoPage */]),
        ],
        providers: [
            __WEBPACK_IMPORTED_MODULE_3__sub_business_tool__["a" /* SubBusinessToolProvider */],
            __WEBPACK_IMPORTED_MODULE_4__subCameconfigServiceProvider__["a" /* SubCameconfigServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_5__providers_service_games_gameconfig_service_gameconfig_service__["a" /* GameconfigServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_6__providers_service_games_basket_service_basket_service__["a" /* BasketServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_7__providers_tools_business_tool__["a" /* BusinessTool */]
        ]
    })
], SaibaoPageModule);

//# sourceMappingURL=saibao.module.js.map
...
var SubBusinessToolProvider = (function (_super) {
    ...
    SubBusinessToolProvider.prototype.SetRenderData = function (c) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SaibaoPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_global_share_global_share__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sub_business_tool__ = __webpack_require__(359);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__subCameconfigServiceProvider__ = __webpack_require__(364);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_jquery__ = __webpack_require__(351);
...
var SaibaoPage = (function () {
    function SaibaoPage(alertCtrl, share, util, basket, gameconfigdata, menuCtrl, navCtrl, navParams, toastCtrl) {
    ...
    SaibaoPage.prototype.ionViewDidLoad = function () {
        this.gameData.money = this.share.balance.available;
        this.basket.totalAllCount = 0;
        this.setData();
    };
    SaibaoPage.prototype.ionViewWillLeave = function () {
        this.menuCtrl.enable(true, 'unauthenticated');
    };
    SaibaoPage.prototype.changeChip = function () {
        if (!this.gameData.chips.change)
            this.gameData.chips.change = 1;
        else
            this.gameData.chips.change = 0;
    };
    SaibaoPage.prototype.selectChip = function (number) {
        this.gameData.chips.change = 0;
        this.gameData.chips.chip = number;
    };
    SaibaoPage.prototype.clickItem = function (game, i, $event) {
        if (this.gameData.chips.change) {
            this.gameData.chips.change = 0;
            return;
        }
    ...
    SaibaoPage.prototype.setData = function () {
        ...
        for (var item in this.gameData) {
            if (item.indexOf('game') > -1) {
                for (var i = 0; i < this.gameData[item].data.length; i++) {
    ...
    SaibaoPage.prototype.goBuyBasket = function (obj) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.gameData.total == 0)) return [3 /*break*/, 1];
                        this.share.showToast('请投注后再提交', 1000);
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.basket.saobaoSubmit(this.basket.basketBall, this)];
                    case 2:
                        _a.sent();
                        this.clearSelect();
                        _a.label = 3;
    ...
    SaibaoPage.prototype.clearSelect = function () {
        for (var item in this.gameData) {
            if (item.indexOf('game') > -1) {
                for (var i = 0; i < this.gameData[item].data.length; i++) {
    ...
    SaibaoPage.prototype.backSelect = function () {
        if (this.gameData.last.length == 0)
            return;
        var r = this.gameData.last.pop();
        for (var item in this.gameData) {
            if (item == r.name) {
                var m = this.gameData[item].data[r.id].g.pop();
    ...
    SaibaoPage.prototype.goHelpPage = function () {
        this.navCtrl.push("PlayHelpPage");
    };
    SaibaoPage.prototype.getvisableHeight = function (obj) {
        var t = obj.offsetTop;
        ...
        var scrollTop = __WEBPACK_IMPORTED_MODULE_6_jquery__(this.saobaocontent.nativeElement).find('.scroll-content').scrollTop();
        return { top: t - scrollTop, left: t2 };
    };
    return SaibaoPage;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])('saobaocontent'),
    __metadata("design:type", Object)
], SaibaoPage.prototype, "saobaocontent", void 0);
SaibaoPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPage */])(),
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-saibao',template:/*ion-inline-start:"/Users/sumail/Downloads/bomao-app/src/pages/games/saibao/saibao.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle="left">\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>\n      <span>{{ gameconfigdata.defaultData.data?.game_name_cn}}</span><img src="assets/img/question.svg" class="question-icon" alt="" (touchstart)="goHelpPage()">\n    </ion-title>\n    <button icon-only class="fr" (touchstart)="share.setMore(1)">\n      <mores></mores>\n    </button>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <div class="container js3-container">\n    <div style="height: 1px;" [class.sscbg]="share?.timers?.divTimer?.show"></div>\n    <div class="s-nav">\n      <div class="s-nav-l">\n        <p class="h-text"><span>{{gameconfigdata.defaultData.data?.current_number}}</span>期 截止时间</p>\n        <div class="t"><span>{{gameconfigdata.clock.minutes}}</span>:<span>{{gameconfigdata.clock.seconds}}</span></div>\n      </div>\n      <div class="s-nav-r">\n        <div class="h-text s-rText" style="text-align: right;">\n          第<span>{{gameconfigdata.defaultData.data?.last_number}}</span>期\n          <p style="clear: both;overflow:hidden;">&nbsp;    &nbsp;    &nbsp;    </p>\n          <p style="    margin-top: 7px;"><!--开奖记录--> </p>\n        </div>\n        <i *ngFor="let num of gameconfigdata.defaultData.data?.lottery_balls" class="saizi saizi-{{num}}" style="margin:0 1px"></i>\n      </div>\n    </div>\n    <div class="game-table">\n      <div class="t-game t-game-1">\n        <div class="t-tit">特殊玩法 1:1</div>\n        <div class="t-list dicedicedaxiaodanshuang">\n          <div class="t-unit" *ngFor="let item of gameData.game1.data;let r=index"\n\n               (touchstart)="clickItem(\'game1\',r,$event)">\n            <p>{{item.p1}}<span>{{item.s}}</span></p>\n            <p>{{item.p2}}</p>\n            <div class="add-coin"><i *ngFor="let c of item.g;let id=index" class="chip chip-{{c}} chip-index-{{id}}"></i></div>\n            <div class="bet-detail">\n              <div class="bet-momey" *ngIf="item.t>0">{{item.t}}</div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class="t-game t-game-2 bg-black1 dicedicedantiaoyishai">\n        <div class="t-tit">猜一个号 单骰1:1 双骰1:2 三骰1:3</div>\n        <div class="t-list">\n          <div class="t-unit" *ngFor="let item of gameData.game2.data;let r=index"\n               (touchstart)="clickItem(\'game2\',r,$event)">\n            <i class="saizi saizi-{{item.p}}"></i>\n            <div class="add-coin"><i *ngFor="let c of item.g;let id=index" class="chip chip-{{c}} chip-index-{{id}}"></i></div>\n            <div class="bet-detail">\n              <div class="bet-momey" *ngIf="item.t>0">{{item.t}}</div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class="t-game t-game-3 dicediceerbutonghao">\n        <div class="t-tit">二不同号 1:5</div>\n        <div class="t-list">\n          <div class="t-unit" *ngFor="let item of gameData.game3.data;let r=index"\n               (touchstart)="clickItem(\'game3\',r,$event)">\n            <i class="saizi saizi-{{item.p1}}"></i>\n            <i class="saizi saizi-{{item.p2}}"></i>\n            <div class="add-coin"><i *ngFor="let c of item.g;let id=index" class="chip chip-{{c}} chip-index-{{id}}"></i></div>\n            <div class="bet-detail">\n              <div class="bet-momey" *ngIf="item.t>0">{{item.t}}</div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class="t-game-4 bg-black1">\n        <div class="t-tit">和值</div>\n        <div class="t-list">\n          <div class="t-unit" *ngFor="let item of gameData.game4.data;let r=index"\n               (touchstart)="clickItem(\'game4\',r,$event)">\n            <p class="t-num">{{item.n}}</p>\n            <p>1:{{item.be}}</p>\n            <div class="add-coin"><i *ngFor="let c of item.g;let id=index" class="chip chip-{{c}} chip-index-{{id}}"></i></div>\n            <div class="bet-detail">\n              <div class="bet-momey" *ngIf="item.t>0">{{item.t}}</div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class="t-game t-game-3 t-game-5 dicediceertonghao">\n        <div class="t-tit">二同号复选 1:10</div>\n        <div class="t-list">\n          <div class="t-unit" *ngFor="let item of gameData.game5.data;let r=index"\n               (touchstart)="clickItem(\'game5\',r,$event)">\n            <i class="saizi saizi-{{item.p}}"></i>\n            <i class="saizi saizi-{{item.p}}"></i>\n            <div class="add-coin"><i *ngFor="let c of item.g;let id=index" class="chip chip-{{c}} chip-index-{{id}}"></i></div>\n            <div class="bet-detail">\n              <div class="bet-momey" *ngIf="item.t>0">{{item.t}}</div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class="t-game t-game-3 t-game-6 bg-black1 dicedicesantonghaotongxuan">\n        <div class="t-tit">三同号 1:30</div>\n        <div class="t-list" *ngFor="let item of gameData.game6.data;let r=index" (touchstart)="clickItem(\'game6\',r,$event)">\n          <div class="t-unit bdr-none" *ngFor="let num of item.p">\n            <div class="t-unit-cow">\n              <i class="saizi saizi-{{num}}"></i>\n            </div>\n            <div class="t-unit-cow">\n              <i class="saizi saizi-{{num}}"></i>\n              <i class="saizi saizi-{{num}}"></i>\n            </div>\n          </div>\n          <div class="add-coin"><i *ngFor="let c of item.g;let id=index" class="chip chip-{{c}} chip-index-{{id}}"></i>\n          </div>\n          <div class="bet-detail">\n            <div class="bet-momey" *ngIf="item.t>0">{{item.t}}</div>\n          </div>\n        </div>\n      </div>\n      <div class="t-game t-game-3 t-game-6 dicedicesantonghao">\n        <div class="t-tit">三同号单选1:180</div>\n        <div class="t-list">\n          <div class="t-unit" *ngFor="let item of gameData.game7.data;let r=index"\n               (touchstart)="clickItem(\'game7\',r,$event)">\n            <div class="t-unit-cow">\n              <i class="saizi saizi-{{item.p}}"></i>\n            </div>\n            <div class="t-unit-cow">\n              <i class="saizi saizi-{{item.p}}"></i>\n              <i class="saizi saizi-{{item.p}}"></i>\n            </div>\n            <div class="add-coin"><i *ngFor="let c of item.g;let id=index" class="chip chip-{{c}} chip-index-{{id}}"></i></div>\n            <div class="bet-detail">\n              <div class="bet-momey" *ngIf="item.t>0">{{item.t}}</div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</ion-content>\n\n<!--页脚内容-->\n<ion-footer>\n  <div class="eBill--bill clear">\n    <div class="bill-detail">\n      <p>下注金额<span>{{gameData.total}}</span></p>\n      <p>账户金额<span>{{gameData.money}}</span></p>\n    </div>\n    <div class="eCurrunt" (touchstart)="changeChip()">\n      <p>当前选择筹码</p>\n      <div class="eCurrunt-coin">\n        <i class="chip chip-{{gameData.chips.chip}}"></i>\n      </div>\n    </div>\n    <div class="coin-list" *ngIf="gameData.chips.change">\n      <div class="coin-list-container">\n        <div class="cow" *ngFor="let row of gameData.chips.show">\n          <div *ngFor="let num of row"><i class="chip chip-{{num}}" (touchstart)="selectChip(num)"></i></div>\n        </div>\n      </div>\n      <div class="e-triangle">\n        <div class="e-inner-triangle"></div>\n      </div>\n    </div>\n  </div>\n  <div class="confirm-bet">\n    <ul>\n      <li class="e-clear">\n        <a href="javascript:;" class="button button-outline" (touchstart)="clearSelect()">清空</a><a href="javascript:;" class="button button-outline" (touchstart)="backSelect()">撤销</a>\n      </li>\n      <li class="confirm-w">\n        <a class="confirm-btn" tabBadge="14" tabBadgeStyle="danger" (touchstart)="goBuyBasket(gameconfigdata?.defaultsMethodData?.c)">\n          <span>确认投注</span><span class="confirm-number" *ngIf="basket.basketData.length">{{basket.basketData?.length}}</span>\n        </a>\n      </li>\n    </ul>\n  </div>\n</ion-footer>\n<!--透明背景-->\n<div class="body-bg"></div>\n'/*ion-inline-end:"/Users/sumail/Downloads/bomao-app/src/pages/games/saibao/saibao.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_2__providers_global_share_global_share__["a" /* GlobalShareProvider */], __WEBPACK_IMPORTED_MODULE_3__sub_business_tool__["a" /* SubBusinessToolProvider */], __WEBPACK_IMPORTED_MODULE_4__providers_service_games_basket_service_basket_service__["a" /* BasketServiceProvider */], __WEBPACK_IMPORTED_MODULE_5__subCameconfigServiceProvider__["a" /* SubCameconfigServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* MenuController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* ToastController */]])
], SaibaoPage);

//# sourceMappingURL=saibao.js.map
