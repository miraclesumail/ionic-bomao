...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__select_bank__ = __webpack_require__(401);
...
SelectBankPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-select-bank',template:/*ion-inline-start:"/Users/sumail/Downloads/bomao-app/src/pages/money/select-bank/select-bank.html"*/'<ion-header>\n  <ion-navbar>\n    <button icon-only class="fr">\n      <mores></mores>\n    </button>\n    <ion-title>选择银行卡</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content class="white-bg">\n  <ul class="bank-list">\n    <li *ngFor="let item of bankCardList" (click)="goBack(item)">\n      <span class="bank-img">\n        <img src="{{bankcardIconMap[item.name]}}" alt="">\n      </span>\n      <span class="bank-text">{{item.name}}</span>\n    </li>\n  </ul>\n</ion-content>\n\n'/*ion-inline-end:"/Users/sumail/Downloads/bomao-app/src/pages/money/select-bank/select-bank.html"*/,
    }),
