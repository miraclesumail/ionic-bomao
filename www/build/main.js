...
var map = {
	...
	"../pages/games/saibao/saibao.module": [
		319,
		0
	],
...
var MyPopOverComponent = (function () {
    function MyPopOverComponent(viewCtrl, navCtrl, share) {
        this.viewCtrl = viewCtrl;
        this.navCtrl = navCtrl;
        this.share = share;
    }
    MyPopOverComponent.prototype.close = function (page, item) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!("GameRecordPage" == page)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.navCtrl.push(page, { title: '投注记录' })];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.navCtrl.push(page, item)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
    ...
    MyPopOverComponent.prototype.setRoot = function (page, item) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.navCtrl.setRoot(page, item)];
                    case 1:
                        _a.sent();
                        this.viewCtrl.dismiss();
                        this.share.moreType = 0;
...
MyPopOverComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'my-pop-over',template:/*ion-inline-start:"/Users/sumail/Downloads/bomao-app/src/components/my-pop-over/my-pop-over.html"*/'<div class="side-nav">\n  <a href="#" *ngIf="share.moreType==0" (touchstart)="close(\'TabHomePage\')" class="side-nav-a j-btn">游戏大厅</a>\n  <a href="#" *ngIf="share.moreType==0" (touchstart)="close(\'SafeCenterPage\')" class="side-nav-a j-btn">账户设置</a>\n  <a href="#" *ngIf="share.moreType==0" (touchstart)="close(\'MessagePage\')" class="side-nav-a j-btn">站内信</a>\n  <a href="#" *ngIf="share.moreType==1" (touchstart)="close(\'GameRecordPage\')" class="side-nav-a j-btn">投注记录</a>\n</div>\n'/*ion-inline-end:"/Users/sumail/Downloads/bomao-app/src/components/my-pop-over/my-pop-over.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* ViewController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__providers_global_share_global_share__["a" /* GlobalShareProvider */]])
], MyPopOverComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__game_util__ = __webpack_require__(255);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_crypto_js__ = __webpack_require__(256);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_underscore__ = __webpack_require__(280);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__global_share__ = __webpack_require__(35);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BalanceProvider = (function () {
    ...
    BalanceProvider.prototype.getBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            var balance;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
BalanceProvider = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__http_client_http_client__["a" /* HttpClientProvider */], __WEBPACK_IMPORTED_MODULE_3__global_share__["a" /* GlobalShareProvider */]])
], BalanceProvider);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_http_client_http_client__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_global_share_global_share__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__MyExceptionHandler__ = __webpack_require__(307);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_my_pop_over_my_pop_over__ = __webpack_require__(207);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_games_jsks_sub_business_tool__ = __webpack_require__(211);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_global_share_balance__ = __webpack_require__(210);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["d" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_5__app_component__["a" /* MyApp */], {
                ...
                links: [
                    ...
                    { loadChildren: '../pages/games/lhc/lhc.module#LhcPageModule', name: 'LhcPage', segment: 'lhc', priority: 'low', defaultHistory: [] },
                    { loadChildren: '../pages/games/pk10/pk10.module#Pk10PageModule', name: 'Pk10Page', segment: 'pk10', priority: 'low', defaultHistory: [] },
                    { loadChildren: '../pages/games/saibao/saibao.module#SaibaoPageModule', name: 'SaibaoPage', segment: 'saibao', priority: 'low', defaultHistory: [] },
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_12__providers_global_share_balance__["a" /* BalanceProvider */]
        ]
    })
], AppModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__config_config__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_tools_date__ = __webpack_require__(212);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GlobalShareProvider = (function () {
    function GlobalShareProvider(toastCtrl, loadingCtrl, alertCtrl) {
        this.toastCtrl = toastCtrl;
        this.loadingCtrl = loadingCtrl;
        this.alertCtrl = alertCtrl;
        this.timers = { divTimer: { timer: null, show: false }, titleTimer: { timer: null, show: false } };
        this.moreType = 0;
        this.basketData = [];
    ...
    GlobalShareProvider.prototype.checkPlatform = function () {
    ...
    GlobalShareProvider.prototype.setTimer = function (name, time, fun) {
        var _this = this;
        var _loop_1 = function (k) {
            if (k == name) {
                clearInterval(this_1.timers[k].timer);
                this_1.timers[k].timer = setInterval(function () {
                    _this.timers[k].show = !_this.timers[k].show;
                    if (fun)
                        fun;
                }, time);
                return { value: void 0 };
    ...
    GlobalShareProvider.prototype.clearTimer = function () {
        for (var k in this.timers) {
            clearInterval(this.timers[k].timer);
        }
    };
    GlobalShareProvider.prototype.setMore = function (num) {
        this.moreType = num;
    };
...
GlobalShareProvider = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["q" /* ToastController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["g" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["a" /* AlertController */]])
], GlobalShareProvider);
...
//static baseurl = "";
Config.baseurl = "http://180.178.42.214";
