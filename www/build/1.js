...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pk10__ = __webpack_require__(379);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_tools_business_tool__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__sub_business_tool__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__subCameconfigServiceProvider__ = __webpack_require__(363);
...
Pk10PageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_6__sub_business_tool__["a" /* SubBusinessToolProvider */],
            __WEBPACK_IMPORTED_MODULE_7__subCameconfigServiceProvider__["a" /* SubCameconfigServiceProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_tools_business_tool__["a" /* BusinessTool */]
        ]
    })
], Pk10PageModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(351);
...
var Effect = (function () {
    function Effect() {
        var _this = this;
        this.writeInput = this.debounce(function (obj, e) { return _this.changeInput(obj, e); }, 500);
    }
    Effect.prototype.initEffect = function (num) {
        if (num) {
            this.dropDown();
            this.rechargeTab();
            this.myModal();
    ...
    Effect.prototype.phoneClick = function (obj, cla) {
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', obj, function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass(cla);
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchend', obj, function () {
    ...
    //水波纹效果
    Effect.prototype.waterEffect = function (obj) {
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', obj, function (e) {
            var newRound = document.createElement('div'), x, y;
            newRound.className = 'circles';
            this.appendChild(newRound);
            x = e.pageX - __WEBPACK_IMPORTED_MODULE_0_jquery__(this).offset().left;
            y = e.pageY - __WEBPACK_IMPORTED_MODULE_0_jquery__(this).offset().top;
    ...
    //左侧彩种下拉
    Effect.prototype.sideDrop = function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', '.side-li', drop);
        function drop() {
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).find('.side-drop').slideToggle(200);
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).siblings().find('.side-drop').slideUp(200);
            return false;
        }
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.side-drop').slideUp(200);
        });
    };
    //首页彩种下拉
    Effect.prototype.dropDown = function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', '.sort-li', drop);
        function drop() {
            var oSort = __WEBPACK_IMPORTED_MODULE_0_jquery__('.sort-li');
            var len = oSort.length;
            function aaa() {
                for (var i = 0; i < len; i++) {
                    if (__WEBPACK_IMPORTED_MODULE_0_jquery__('.sort-list').find('.sort-drop').eq(i).css('display') == 'block')
                        return true;
                }
                return false;
            }
            if (aaa()) {
                ...
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).find('.sort-a').addClass('sort-col');
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).find('.definite-sort').addClass('sort-col');
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).find('.sort-drop').slideDown();
            }
            return false;
        }
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.sort-li').find('.sort-a').removeClass('sort-col');
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.sort-li').find('.definite-sort').removeClass('sort-col');
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.sort-drop').slideUp(0);
        });
    };
    //tab切换
    Effect.prototype.rechargeTab = function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', '.recharge-tab li', recharge);
        function recharge() {
            var oDiv = __WEBPACK_IMPORTED_MODULE_0_jquery__('.recharge');
            var i = __WEBPACK_IMPORTED_MODULE_0_jquery__(this).index();
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.recharge-tab li').removeClass('active');
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass('active');
            oDiv.each(function () {
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).find('.recharge-con').hide().eq(i).show();
            });
        }
    };
    //从下往上的弹出框
    Effect.prototype.myModal = function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', '.open-modal', function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.body-bg').fadeIn(300);
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.alert-con').addClass('alert-show');
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', '.body-bg,.close-modal', function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.body-bg').fadeOut(300);
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.alert-con').removeClass('alert-show');
        });
    };
    //函数节流
    ...
    Effect.prototype.moneyDrop = function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery__('.money-btn-1,.money-btn-2').each(function () {
            var This = __WEBPACK_IMPORTED_MODULE_0_jquery__(this);
    ...
    Effect.prototype.changeInput = function (obj, e) {
        var num = +e.target.value;
        num = num < obj.min ? obj.min : (num > obj.max ? obj.max : num);
        e.target.value = num;
        obj.num = num;
    };
    Effect.prototype.numChange = function (obj, type) {
        var num = obj.num;
        if (type == '+') {
            if (num < obj.max)
                num++;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__game_common_labelmap__ = __webpack_require__(362);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_service_games_gameconfig_service_gameconfig_service__ = __webpack_require__(350);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_http_client_http_client__ = __webpack_require__(109);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_global_share_global_share__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_games_basket_service_basket_service__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__effect__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__sub_business_tool__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__subCameconfigServiceProvider__ = __webpack_require__(363);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__game_common_labelmap__ = __webpack_require__(362);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var Pk10Page = (function (_super) {
    ...
    function Pk10Page(share, util, basket, gameconfigdata, menuCtrl, navCtrl, navParams, toastCtrl) {
        var _this = _super.call(this) || this;
        _this.share = share;
        _this.util = util;
        _this.basket = basket;
        ...
        _this.ballLabelMap = __WEBPACK_IMPORTED_MODULE_7__game_common_labelmap__["a" /* LableMap */].label;
        _this.pluseOrmindusOnInput = _this.debounce(function (obj, e) { return _this.pluseOrmindus(obj, e); }, 1000);
        _this.share.setTimer('divTimer', 800);
    ...
    Pk10Page.prototype.addBall = function (obj) {
        var isSucess = this.basket.addDataToBasketPK10(obj);
        if (isSucess) {
            this.clear(obj);
            this.share.showToast('注单添加成功', 1000, 'bottom');
        }
