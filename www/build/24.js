...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__message_detail__ = __webpack_require__(387);
...
MessageDetailPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-message-detail',template:/*ion-inline-start:"/Users/sumail/Downloads/bomao-app/src/pages/message/message-detail/message-detail.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>站内信详情</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding class="gray-bg">\n  <h1 class="special-title">{{home?.messageDetail?.msg_title}}</h1>\n  <div class="help-wrap" [innerHtml]="home?.messageDetail?.content"></div>\n</ion-content>\n\n'/*ion-inline-end:"/Users/sumail/Downloads/bomao-app/src/pages/message/message-detail/message-detail.html"*/,
    }),
