...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__game_record__ = __webpack_require__(405);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_tools_date__ = __webpack_require__(211);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_home_service_home_service__ = __webpack_require__(346);
...
var GameRecordPage = (function () {
    ...
    GameRecordPage.prototype.recordLogin = function () {
        ...
        this.eventOne = {
            timeStarts: __WEBPACK_IMPORTED_MODULE_3__providers_tools_date__["a" /* DateFormat */].format(d),
            timeEnds: __WEBPACK_IMPORTED_MODULE_3__providers_tools_date__["a" /* DateFormat */].format(new Date()),
            id: null
        };
        _.observe(this.eventOne, function () { return _this.changeParameter(_this.titleIndex); });
        this.viewCtrl.didEnter.subscribe(function () {
            _.observe(_this.share.parameters[_this.titleIndex], function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
