...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bet_detail_more__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_betrecord_service_betrecord_detail_service__ = __webpack_require__(359);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_betrecord_service_betrecord_detail_service__ = __webpack_require__(359);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BetDetailMorePage = (function () {
    function BetDetailMorePage(navCtrl, params, betrecordDetailService) {
        var _this = this;
    ...
    BetDetailMorePage.prototype.getIDs = function () {
        return this.params.get('tplData') && this.params.get('tplData').successful && this.params.get('tplData').successful.map(function (v) { return v.id; }).join(',');
    };
...
BetDetailMorePage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-bet-detail-more',template:/*ion-inline-start:"/Users/eric.ch/Documents/bomao-app/src/pages/games/game-common/bet-detail-more/bet-detail-more.html"*/'<!--\n  Generated template for the BetDetail page.\n\n  See http://ionicframework.com/docs/v2/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <button icon-only class="fr">\n      <mores></mores>\n    </button>\n    <ion-title>投注详情</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content class="gray-bg">\n  <div style="height: 1px;" [class.sscbg]="ccc" ></div>\n  <div class="betdetail-bg">\n    <div *ngFor="let data of betrecordDetailService.betDetailParametersData.projects">\n      <div class="bet-wrap">\n        <div class="bet-detail clear">\n          <div class="bet-l">\n            <div><span>{{data.title}}</span></div>\n            <div><span>第{{data.issue}}期</span></div>\n            <div><span>注单金额：</span><span class="gray">￥{{data.amount}}</span></div>\n            <div class="mt5" *ngIf="data.winning_number"><span>中奖金额：</span><span\n              class="col">￥{{data.winning_number }}</span></div>\n          </div>\n          <div class="bet-r">\n            <div class="" *ngIf="data.winning_number">\n              <i class="num-green" *ngFor="let num of data.winning_number">1</i>\n              <i class="num-green">{{num}}</i>\n            </div>\n\n            <div>下注时间：</div>\n            <div>{{data.bought_at}}</div>\n          </div>\n        </div>\n        <ul class="bet-list">\n          <li><span>模式：</span><span class="gray">{{({\'1.00\':\'元\',\'0.1\':\'角\',\'0.01\':"分"}[data.coefficient])}}</span>\n          </li>\n          <li><span>倍数：</span><span class="gray">{{data.multiple}}倍</span></li>\n          <li><span>投注内容：</span><span class="gray">{{data.display_bet_number}}</span>\n          </li>\n          <li><span>注单编号：</span><span class="gray">{{data.serial_number}}</span></li>\n          <li><span>订单状态：</span><span class="gray">{{(statusName[data.status])}}</span>\n          </li>\n        </ul>\n      </div>\n    </div>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/eric.ch/Documents/bomao-app/src/pages/games/game-common/bet-detail-more/bet-detail-more.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_service_betrecord_service_betrecord_detail_service__["a" /* BetrecordDetailService */]])
], BetDetailMorePage);
