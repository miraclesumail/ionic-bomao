...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__notice_detail__ = __webpack_require__(401);
...
NoticeDetailPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__notice_detail__["a" /* NoticeDetailPage */]),
        ],
...
var NoticeDetailPage = (function () {
    function NoticeDetailPage(navCtrl, homeService, params) {
        this.navCtrl = navCtrl;
        this.homeService = homeService;
        this.params = params;
        this.Config = __WEBPACK_IMPORTED_MODULE_3__config_config__["a" /* Config */];
    }
...
NoticeDetailPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-notice-detail',template:/*ion-inline-start:"/Users/eric.ch/Documents/bomao-app/src/pages/notice/notice-detail/notice-detail.html"*/'<ion-header>\n  <ion-navbar>\n    <button icon-only class="fr">\n      <mores></mores>\n    </button>\n    <ion-title>公告详情</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="gray-bg">\n  <no-data-remind *ngIf="!params.get(\'notice\').title"></no-data-remind>\n  <div padding *ngIf="params.get(\'notice\').title">\n    <h1 class="special-title">{{params.get(\'notice\').title}}</h1>\n    <div class="help-wrap" [innerHtml]="Config.repleceImgSrc(params.get(\'notice\').content)"></div>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/eric.ch/Documents/bomao-app/src/pages/notice/notice-detail/notice-detail.html"*/,
    }),
