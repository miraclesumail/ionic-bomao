...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JsksPageModule", function() { return JsksPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jsks__ = __webpack_require__(376);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_userbalance_service_userbalance_service__ = __webpack_require__(350);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__sub_business_tool__ = __webpack_require__(210);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_tools_business_tool__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__subCameconfigServiceProvider__ = __webpack_require__(360);
...
var JsksPageModule = (function () {
    function JsksPageModule() {
    }
    return JsksPageModule;
}());
JsksPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__jsks__["a" /* JsksPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__jsks__["a" /* JsksPage */]),
        ],
        providers: [
            __WEBPACK_IMPORTED_MODULE_7__sub_business_tool__["a" /* SubBusinessToolProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_service_games_basket_service_basket_service__["a" /* BasketServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_4__providers_service_userbalance_service_userbalance_service__["a" /* UserbalanceServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_6__providers_service_games_gamelist_service__["a" /* Gamelist */],
            __WEBPACK_IMPORTED_MODULE_8__providers_tools_business_tool__["a" /* BusinessTool */]
        ]
    })
], JsksPageModule);

//# sourceMappingURL=jsks.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sub_business_tool__ = __webpack_require__(210);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JsksPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_games_gamelist_service__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_service_games_basket_service_basket_service__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__sub_business_tool__ = __webpack_require__(210);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__subCameconfigServiceProvider__ = __webpack_require__(360);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__game_common_effect__ = __webpack_require__(354);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var JsksPage = (function (_super) {
    __extends(JsksPage, _super);
    function JsksPage(share, util, gameinfo, basket, gameconfigdata, menuCtrl, navCtrl, navParams, toastCtrl) {
        var _this = _super.call(this) || this;
        _this.share = share;
        _this.util = util;
        ...
        _this.c = { selectarea: [], selectareaPair: [] };
        _this.b = { selectarea: [], selectareaPair: [] };
        _this.a = { selectarea: [], selectareaPair: [] };
        _this.ballLabelMap = __WEBPACK_IMPORTED_MODULE_2__config_config__["a" /* Config */].ballLabelMap;
        _this.yearReg = /[\d]{4}-/;
    ...
    JsksPage.prototype.selectall = function (arr) {
        if (arr.every(function (v) { return v; })) {
            arr.forEach(function (v, k, arr) { return arr[k] = false; });
        }
        else {
            arr.forEach(function (v, k, arr) { return arr[k] = true; });
        }
    };
    JsksPage.prototype.tmpComformMethod = function (a, b, c) {
        this.methodGroup = {
            a: a, b: b, c: c
        };
    };
    JsksPage.prototype.ionViewDidLoad = function () {
        this.initEffect();
    };
    JsksPage.prototype.ionViewWillLeave = function () {
        this.menuCtrl.enable(true, 'unauthenticated');
    };
    JsksPage.prototype.other = function () {
        var _this = this;
    ...
    JsksPage.prototype.setGrounpChoose = function (name, arr, value) {
        this.util.daxiaodanshuangqing(arr, name, value);
    };
    JsksPage.prototype.comformMethod = function () {
    ...
    JsksPage.prototype.modeChange = function (obj, mode) {
    ...
    JsksPage.prototype.restTimesWhenChangeMode = function (obj) {
        if (obj.mutipleAndModeObj.times >= obj.max_multiple) {
            obj.mutipleAndModeObj.times = obj.max_multiple;
        }
    };
    JsksPage.prototype.messages = function (obj) {
    ...
    JsksPage.prototype.addBall = function (obj) {
        var isSucess = this.basket.addDataToBasketK3(obj);
        if (isSucess) {
            this.clear(obj);
            var toast = this.toastCtrl.create({
                message: '注单添加成功',
    ...
    JsksPage.prototype.goBuybasket = function (obj) {
        var isSucess = this.basket.addDataToBasketK3(obj);
