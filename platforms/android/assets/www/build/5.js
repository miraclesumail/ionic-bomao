...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__buy_basket__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_games_basket_service_basket_service__ = __webpack_require__(351);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_service_games_gameconfig_service_gameconfig_service__ = __webpack_require__(349);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__effect__ = __webpack_require__(375);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_global_share_global_share__ = __webpack_require__(55);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var BuyBasketPage = (function (_super) {
    ...
    function BuyBasketPage(share, navCtrl, basket, userbalance, gameconfig) {
        var _this = _super.call(this) || this;
        _this.share = share;
        ...
        _this.tracepluseOrmindusOnInput = debounce(function (e) {
            _this.tracepluseOrmindus(e);
        }, 1000);
        _this.mutiplepluseOrmindusOnInput = debounce(function (e) {
            _this.mutiplepluseOrmindus(e);
        }, 1000);
        _this.percent = 0;
        return _this;
    }
    ...
    BuyBasketPage.prototype.mutiplePluse = function () {
        this.share.globalData.globalMutile++;
    };
    BuyBasketPage.prototype.tracePluse = function () {
        this.share.globalData.trace++;
    };
    BuyBasketPage.prototype.traceReduce = function () {
        this.share.globalData.trace--;
        this.share.globalData.trace = Math.max(this.share.globalData.trace, 1);
    };
    BuyBasketPage.prototype.mutipleReduce = function () {
        this.share.globalData.globalMutile--;
        this.share.globalData.globalMutile = Math.max(this.share.globalData.globalMutile, 1);
    };
    BuyBasketPage.prototype.tracepluseOrmindus = function (e) {
    ...
    BuyBasketPage.prototype.mutiplepluseOrmindus = function (e) {
        var v = +e.target.value;
        if (v <= 1) {
            this.share.globalData.globalMutile = 1;
        }
    ...
    BuyBasketPage.prototype.filterIndex = function (num) {
        var r = /\.0{7}/;
        var a = String(num);
        if (r.test(a)) {
...
var Effect = (function () {
    ...
    Effect.prototype.moneyDrop = function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery__('.money-btn-1').each(function () {
