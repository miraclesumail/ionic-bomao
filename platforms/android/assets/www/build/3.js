...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__get_money__ = __webpack_require__(393);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_money_serice_money_serice__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_components_module__ = __webpack_require__(343);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_service_fund_service_bankcard_service__ = __webpack_require__(347);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_service_fund_service_setfundpassword_service__ = __webpack_require__(356);
...
var GetMoneyPageModule = (function () {
...
GetMoneyPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__get_money__["a" /* GetMoneyPage */]),
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_3__providers_service_money_serice_money_serice__["a" /* MoneySericeProvider */], __WEBPACK_IMPORTED_MODULE_5__providers_service_fund_service_bankcard_service__["a" /* BankcardService */], __WEBPACK_IMPORTED_MODULE_6__providers_service_fund_service_setfundpassword_service__["a" /* SetfundpasswordService */]],
        entryComponents: []
    })
], GetMoneyPageModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__global_share_global_share__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__http_client_http_client__ = __webpack_require__(206);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_tools_observe__ = __webpack_require__(209);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_service_fund_service_bankcard_service__ = __webpack_require__(347);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_service_fund_service_setfundpassword_service__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_global_share_global_share__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_service_money_serice_money_serice__ = __webpack_require__(352);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var _ = new __WEBPACK_IMPORTED_MODULE_4__providers_tools_observe__["a" /* observe */]();
var GetMoneyPage = (function () {
    function GetMoneyPage(share, money, viewCtrl, navCtrl, bankcard, setfundpasswordService) {
        this.share = share;
        this.money = money;
    ...
    GetMoneyPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        _.observe(this.select, 'update', function () { return _this.changeCard(); });
    };
    GetMoneyPage.prototype.changeCard = function () {
        var _this = this;
        this.money.selectCard = this.money.withdraw.data.bank_cards.filter(function (v) { return v.account == _this.select.card; })[0];
        __WEBPACK_IMPORTED_MODULE_3_jquery__('.body-bg').fadeOut(300);
        __WEBPACK_IMPORTED_MODULE_3_jquery__('.alert-con').removeClass('alert-show');
    };
    GetMoneyPage.prototype.getMoneyToCard = function () {
        var _this = this;
        var max = 500000;
        if (this.checkBind())
            return;
        if (isNaN(this.money.parameters.amount) || this.money.parameters.amount < 2)
            this.money.parameters.amount = 2;
        if (this.money.withdraw.data.accounts.withdrawable < max)
            max = this.money.withdraw.data.accounts.withdrawable;
        if (this.money.parameters.amount > max)
            this.money.parameters.amount = max;
        this.share.showAlert('请输入资金密码', [{ text: '取消', handler: function (data) { } },
            { text: '确认',
                handler: function (data) {
                    if (!!data.password) {
                        _this.money.parameters.fund_password = data.password;
                        _this.money.postWithdraw();
                    }
    ...
    GetMoneyPage.prototype.checkBind = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.money.getTimes == 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.money.getWithdraw()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
    ...
    GetMoneyPage.prototype.dismiss = function () {
        this.viewCtrl.dismiss({ 'foo': 'bar' });
    };
    GetMoneyPage.prototype.pushPage = function (page) {
        if (page)
...
GetMoneyPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-get-money',template:/*ion-inline-start:"/Users/eric.ch/Documents/bomao-app/src/pages/money/get-money/get-money.html"*/'<ion-header>\n  <ion-navbar>\n    <button icon-only class="fr"><mores></mores></button>\n    <ion-title>提款</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content class="gray-bg">\n  <div class="balance">{{money.selectCard?.account_name}}</div>\n  <div class="balance">余额：{{share.user?.available}}</div>\n  <div *ngIf="money.selectCard?.bank" class="open-modal recharge-bank">\n    <img src="{{bankcardIconMap[money.selectCard?.bank]}}" alt="">\n    <span class="bank-detail">\n      <span class="name"><i>{{money.selectCard?.bank}}</i><!--<i class="save">储蓄卡</i>--></span>\n      <span class="number">**** **** **** {{money.selectCard?.account.slice(-4)}}</span>\n    </span>\n    <span class="get-icon fr"><i class="iconfont icon-fanhui icon-right"></i></span>\n  </div>\n  <div class="recharge-money">\n    <div class="get-box clear">\n      <span class="get-l fl"><i class="rmb fl">￥</i> <i class="line fl">|</i></span>\n      <div class="get-r clear"><input autocomplete="false" type="number" [(ngModel)]="money.parameters.amount" class="money-input"></div>\n    </div>\n    <div class="get-border clear">\n      <span class="fl col-1">可提金额：￥{{money.withdraw.data.accounts.withdrawable}}</span>\n      <span class="fr col" (click)="money.getAll()">全部提出</span>\n    </div>\n  </div>\n  <div class="remind">单笔最低提现金额：2.00元，最高500,000.00元</div>\n  <div class="save-btn">\n    <button ion-button full (click)="getMoneyToCard()">立即提现</button>\n  </div>\n</ion-content>\n\n<!--透明背景-->\n<div class="body-bg"></div>\n<!--弹框内容-->\n<div class="alert-con">\n  <div class="bank-tit">选择提款银行卡</div>\n  <ion-list  radio-group [(ngModel)]="select.card" >\n    <ion-item *ngFor="let item of money.withdraw.data.bank_cards">\n      <ion-label>\n        <div class="recharge-bank">\n          <img src="{{bankcardIconMap[item.name]}}" alt="">\n          <span class="bank-detail">\n            <span class="name">{{item.bank}}（尾号{{item.account.slice(-4)}}）</span>\n          </span>\n        </div>\n      </ion-label>\n      <ion-radio  value="{{item.account}}"></ion-radio>\n    </ion-item>\n  </ion-list>\n</div>\n'/*ion-inline-end:"/Users/eric.ch/Documents/bomao-app/src/pages/money/get-money/get-money.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_7__providers_global_share_global_share__["a" /* GlobalShareProvider */], __WEBPACK_IMPORTED_MODULE_8__providers_service_money_serice_money_serice__["a" /* MoneySericeProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* ViewController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_5__providers_service_fund_service_bankcard_service__["a" /* BankcardService */], __WEBPACK_IMPORTED_MODULE_6__providers_service_fund_service_setfundpassword_service__["a" /* SetfundpasswordService */]])
], GetMoneyPage);
