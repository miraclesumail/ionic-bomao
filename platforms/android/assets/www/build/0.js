...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Pk10PageModule", function() { return Pk10PageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pk10__ = __webpack_require__(377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_games_gameconfig_service_gameconfig_service__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_games_basket_service_basket_service__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_service_userbalance_service_userbalance_service__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_tools_business_tool__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_service_games_gamelist_service__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sub_business_tool__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__subCameconfigServiceProvider__ = __webpack_require__(362);
...
var Pk10PageModule = (function () {
    function Pk10PageModule() {
    }
    return Pk10PageModule;
}());
Pk10PageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__pk10__["a" /* Pk10Page */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__pk10__["a" /* Pk10Page */]),
        ],
        providers: [
            __WEBPACK_IMPORTED_MODULE_8__sub_business_tool__["a" /* SubBusinessToolProvider */],
            __WEBPACK_IMPORTED_MODULE_9__subCameconfigServiceProvider__["a" /* SubCameconfigServiceProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_service_userbalance_service_userbalance_service__["a" /* UserbalanceServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_7__providers_service_games_gamelist_service__["a" /* Gamelist */],
            __WEBPACK_IMPORTED_MODULE_6__providers_tools_business_tool__["a" /* BusinessTool */]
        ]
    })
], Pk10PageModule);

//# sourceMappingURL=pk10.module.js.map
...
var GameconfigServiceProvider = (function () {
    ...
    GameconfigServiceProvider.prototype.fetchMethedsList = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpclient.post("/mobile-lotteries-h5/load-data/2/" + this.share.getPid(), this.getParamaterToken())];
                    case 1:
                        data = _a.sent();
    ...
    GameconfigServiceProvider.prototype.getDefaultsMethods = function () {
        return __awaiter(this, void 0, void 0, function () {
            var gameID, defaultData, _a, _b, str;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        gameID = +this.share.getPid();
                        _a = this.share;
                        _b = this;
                        return [4 /*yield*/, this.httpclient.post("/mobile-lotteries-h5/load-data/1/" + gameID + "?_=" + Math.random(), this.getParamaterToken())];
                    case 1:
    ...
    GameconfigServiceProvider.prototype.getIssues = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpclient.post("/mobile-lotteries-h5/load-data/3/" + this.share.getPid(), this.getParamaterToken())];
                    case 1:
                        data = _a.sent();
    ...
    GameconfigServiceProvider.prototype.setPid = function (name) {
        this.share.setPid(name);
        this.pid = name;
    };
    GameconfigServiceProvider.prototype.getPid = function () {
        return this.pid;
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UserbalanceServiceProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
var UserbalanceServiceProvider = (function () {
    function UserbalanceServiceProvider(httpclient, share) {
        this.httpclient = httpclient;
        this.share = share;
        this.balance = { available: 0 };
    }
    UserbalanceServiceProvider.prototype.getBalaceAgain = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpclient.get('/mobileh5-users/user-account-info')];
                    case 1:
                        data = _a.sent();
    ...
    return UserbalanceServiceProvider;
}());
UserbalanceServiceProvider = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
...
//# sourceMappingURL=userbalance-service.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__gameconfig_service_gameconfig_service__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__global_share_global_share__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__userbalance_service_userbalance_service__ = __webpack_require__(350);
...
var BasketServiceProvider = (function (_super) {
    ...
    function BasketServiceProvider(userbalance, share, gameconfigure, httpclient) {
    ...
    BasketServiceProvider.prototype.getMinMutipleAndTotalAllCount = function () {
        ...
        this.share.basketData.forEach(function (v) {
            _this.totalAllCount += (v.mutipleAndModeObj.mode * v.mutipleAndModeObj.times * v.price * _this.share.globalData.globalMutile * _this.share.globalData.trace * v.count);
            _this.totalAllCount = +_this.totalAllCount.toFixed(4);
...
BasketServiceProvider = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__userbalance_service_userbalance_service__["a" /* UserbalanceServiceProvider */], __WEBPACK_IMPORTED_MODULE_4__global_share_global_share__["a" /* GlobalShareProvider */], __WEBPACK_IMPORTED_MODULE_3__gameconfig_service_gameconfig_service__["a" /* GameconfigServiceProvider */], __WEBPACK_IMPORTED_MODULE_1__http_client_http_client__["a" /* HttpClientProvider */]])
...
var Gamelist = (function () {
    function Gamelist(http, share) {
        ...
        this.lottoryList = [];
        this.storeKey = "gamelist";
        this.recordlist = [];
    }
    Gamelist.prototype.groupData = function (data) {
        for (var key in data) {
            if (data[key].time)
                data[key].time = data[key].time.replace(/-/g, '/');
        }
        var obj = data;
        var list = Object.keys(obj).map(function (k) { return obj[k]; });
        var listFitered = [];
        listFitered.unshift({
            haschildren: true, children: list.filter(function (v, key) {
                if (/K3/.test(v.nav)) {
                    delete list[key];
                    return v;
                }
        ...
        var result = listFitered.concat(Object.keys(list).map(function (k) { return list[k]; }));
    ...
    Gamelist.prototype.getRecord = function () {
        this.getGameRecord('/mobileh5-projects');
    };
    Gamelist.prototype.getGameRecord = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var list;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.post(url, { _token: this.share.user.token })];
                    case 1:
                        list = _a.sent();
                        if (list.data) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(348);
...
var MoveShow = (function () {
    function MoveShow(options) {
        this.wrap = options.wrap || __WEBPACK_IMPORTED_MODULE_0_jquery__('#wrap');
        this.inner = options.inner || __WEBPACK_IMPORTED_MODULE_0_jquery__('#inner-side');
        this.outSide = options.outSide || __WEBPACK_IMPORTED_MODULE_0_jquery__('#out-side');
        this.delayTime = 150;
        this.endX = 0;
        this.endY = 0;
        this.oldY = 0;
    ...
    MoveShow.prototype.scale = function () {
        var oTime = __WEBPACK_IMPORTED_MODULE_0_jquery__('.times');
        oTime.on('touchstart', function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass('scales');
        });
        oTime.on('touchend', function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).removeClass('scales');
        });
    };
    MoveShow.prototype.bindEvent = function () {
        var _this = this;
        var self = this;
        self.wrap.on('touchstart', function () {
            self.wrap = __WEBPACK_IMPORTED_MODULE_0_jquery__('#wrap');
            self.inner = __WEBPACK_IMPORTED_MODULE_0_jquery__('#inner-side');
            self.outSide = __WEBPACK_IMPORTED_MODULE_0_jquery__('#out-side');
            _this.heights = __WEBPACK_IMPORTED_MODULE_0_jquery__('#inner-side').outerHeight();
            _this.x = _this.heights / 2;
            _this.y = _this.heights / 2;
        });
        self.wrap.on('touchstart', function (e) {
            ...
            self.aTime = Date.now();
            //添加动画样式
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).removeClass('backanimate');
            //self.oldY为0时让body显示
            if (self.oldY == 0) {
        ...
        self.wrap.on('touchmove', function (e) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).css('transform', 'translate3d(0, ' + self.nowY + 'px, 0)');
        });
        self.wrap.on('touchend', function (e) {
            self.bTime = Date.now();
            var isMinTime = (self.bTime - self.aTime) <= self.delayTime;
            //添加动画
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass('backanimate');
            //self.endY 小于设定的高度弹回去,当手指左右移动时让out-side回到初始位置
            //self.endY 大于设定的高度则到最大高度
            if (self.nowY >= self.y) {
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).css('transform', 'translate3d(0, ' + self.heights + 'px, 0)');
                self.oldY = self.heights;
            }
            //当时间小于0.2s并且self.moveY < -20时，弹回去
            if (isMinTime && self.moveY < -20) {
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).css('transform', 'translate3d(0, 0, 0)');
                self.oldY = 0;
            }
            //self.endY 小于设定的高度弹回去,当手指左右移动时让out-side回到初始位置
            //self.endY 小于设定的高度弹回去,当手指左右移动时让out-side回到初始位置
...
var Effect = (function () {
    ...
    Effect.prototype.initEffect = function () {
        ...
        this.handler = this.debounce(function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.side-right').each(function () {
                var oText = __WEBPACK_IMPORTED_MODULE_0_jquery__(this).find('.side-black');
                oText.off('click').on('click', function () {
                    oText.removeClass('side-green');
                    __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass('side-green');
                });
            });
        }, 500, false);
        new MoveShow({ wrap: __WEBPACK_IMPORTED_MODULE_0_jquery__('#wrap'), outSide: __WEBPACK_IMPORTED_MODULE_0_jquery__('#out-side'), inner: __WEBPACK_IMPORTED_MODULE_0_jquery__('#inner-side') });
    };
    //函数节流
    Effect.prototype.debounce = function (func, wait, immediate) {
    ...
    Effect.prototype.myTab = function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', '.play-list .play-black', tab);
        function tab() {
            var oI = __WEBPACK_IMPORTED_MODULE_0_jquery__('.play-list').find('.play-black');
            var oDiv = __WEBPACK_IMPORTED_MODULE_0_jquery__('.after-select .after-con');
            var i = oI.index(__WEBPACK_IMPORTED_MODULE_0_jquery__(this));
            oI.removeClass('play-yellow');
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass('play-yellow');
            oDiv.eq(i).siblings().removeClass('active');
            oDiv.eq(i).addClass('active');
        }
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', '.play-opacity', select);
        function select() {
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.play-opacity').removeClass('play-yellow');
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass('play-yellow');
        }
    };
    Effect.prototype.moneyDrop = function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery__('.money-btn-2').each(function () {
            var This = __WEBPACK_IMPORTED_MODULE_0_jquery__(this);
            var oLi = This.next('.money-menu').find('li');
            This.click(function () {
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).next('.money-menu').slideDown(200);
                return false;
            });
            oLi.click(function () {
                oLi.removeClass('active');
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass('active');
                This.find('i').text(__WEBPACK_IMPORTED_MODULE_0_jquery__(this).text());
            });
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('touchstart', function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery__('.money-menu').slideUp(200);
        });
    };
    return Effect;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__game_common_labelmap__ = __webpack_require__(361);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var SubBusinessToolProvider = (function (_super) {
    ...
    SubBusinessToolProvider.prototype.initSetBussiness = function (c) {
        ...
        var betarr = [];
        var bet_numberArrObj = betarr;
        var selectareaPair = betarr;
        var selectarea = [];
    ...
    SubBusinessToolProvider.prototype.createLabelAndBall = function (c) {
        var arr = [];
        var bn = c.bet_number;
        for (var key in bn) {
            var item = {};
            ...
            if (Array.isArray(v)) {
                if (typeof v[0] == 'string') {
                    var narr = v[0].split('-');
                    c.isnumberBall = true;
                    item[__WEBPACK_IMPORTED_MODULE_2__game_common_labelmap__["a" /* LableMap */].label[key]] = this.createNumberRange(narr[0], narr[1]);
                }
                else {
                    //龙,虎
                    c.islonghu = true;
                    item[__WEBPACK_IMPORTED_MODULE_2__game_common_labelmap__["a" /* LableMap */].label[key]] = v;
                }
            }
            else {
                c.isdansuang = true;
                item[__WEBPACK_IMPORTED_MODULE_2__game_common_labelmap__["a" /* LableMap */].label[key]] = v.split(',').map(function (v1) { return __WEBPACK_IMPORTED_MODULE_2__game_common_labelmap__["a" /* LableMap */].label[v1]; });
            }
            arr.push(item);
        }
        c.bet_number = arr;
    ...
    SubBusinessToolProvider.prototype.findCounter = function (name, obj) {
        var inputData = this.getCount(obj.selectarea, obj.bet_numberArrObj);
    ...
    SubBusinessToolProvider.prototype.countArr = function (data) {
        var total = 0;
        for (var i = 0; i < data.length; i++)
            total += data[i].length;
        return total;
    };
    SubBusinessToolProvider.prototype.getCount = function (data, back) {
        var outputData = [];
        for (var i = 0; i < data.length; i++) {
            var lineData = [];
            for (var j = 0; j < data[i].value.length; j++) {
                if (data[i].value[j])
                    lineData.push(back[i].value[j]);
            }
            outputData.push(lineData);
        }
        return outputData;
    };
    SubBusinessToolProvider.prototype.countArrPK10 = function (data) {
        var total = 0;
        var start = 0;
        var flag = [];
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            for (var j = start; j < data[i].length; j++) {
                ...
                if (j == data[i].length - 1)
                    endFlag = 1;
                if (this.checkUse(data[i][j], flag))
                    continue;
                if (i == data.length - 1) {
                    total++;
                }
    ...
    SubBusinessToolProvider.prototype.checkUse = function (number, data) {
        for (var i = 0; i < data.length; i++) {
    ...
    SubBusinessToolProvider.prototype.createLabelAndBallPair = function (bet_number, selectarea, bet_numberArrObj, c) {
        bet_number.forEach(function (v, k) {
            var item = {};
            var originitem2 = {};
            for (var key in v) {
                originitem2.showgroup = !/^liangmianpan|zhixuanhezhi/.test(c.fullName_en);
                originitem2.key = item.key = key;
                item.value = v[key].map(function (v) { return false; });
                originitem2.value = v[key].map(function (v) { return v; });
            }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LableMap; });
var LableMap = (function () {
    function LableMap() {
    }
    return LableMap;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SubCameconfigServiceProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_service_games_gameconfig_service_gameconfig_service__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_global_share_global_share__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sub_business_tool__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_http_client_http_client__ = __webpack_require__(206);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var SubCameconfigServiceProvider = (function (_super) {
    __extends(SubCameconfigServiceProvider, _super);
    function SubCameconfigServiceProvider(share, businessTool, httpclient) {
        var _this = _super.call(this, share, businessTool, httpclient) || this;
        _this.share = share;
        _this.businessTool = businessTool;
        _this.httpclient = httpclient;
        return _this;
    }
    SubCameconfigServiceProvider.prototype.setdefaultsMethodData = function () {
        var df = this.businessTool.setDefaultsMethod(this.methedsList.game_ways, this.defaultData.data && this.defaultData.data.default_method_id, this.defaultData);
        if (df) {
            this.defaultsMethodData = df;
        }
    };
    return SubCameconfigServiceProvider;
}(__WEBPACK_IMPORTED_MODULE_1__providers_service_games_gameconfig_service_gameconfig_service__["a" /* GameconfigServiceProvider */]));
SubCameconfigServiceProvider = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_global_share_global_share__["a" /* GlobalShareProvider */], __WEBPACK_IMPORTED_MODULE_3__sub_business_tool__["a" /* SubBusinessToolProvider */], __WEBPACK_IMPORTED_MODULE_4__providers_http_client_http_client__["a" /* HttpClientProvider */]])
], SubCameconfigServiceProvider);

//# sourceMappingURL=subCameconfigServiceProvider.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Pk10Page; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_global_share_global_share__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_games_gamelist_service__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_games_basket_service_basket_service__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__game_common_effect__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__sub_business_tool__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__subCameconfigServiceProvider__ = __webpack_require__(362);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__game_common_labelmap__ = __webpack_require__(361);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
 ...
 */
var Pk10Page = (function (_super) {
    __extends(Pk10Page, _super);
    function Pk10Page(share, util, gameinfo, basket, gameconfigdata, menuCtrl, navCtrl, navParams, toastCtrl) {
        var _this = _super.call(this) || this;
        _this.share = share;
        _this.util = util;
        _this.gameinfo = gameinfo;
        _this.basket = basket;
        _this.gameconfigdata = gameconfigdata;
        _this.menuCtrl = menuCtrl;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.toastCtrl = toastCtrl;
        _this.ballLabelMap = __WEBPACK_IMPORTED_MODULE_8__game_common_labelmap__["a" /* LableMap */].label;
        _this.yearReg = /[\d]{4}-/;
        _this.pluseOrmindusOnInput = debounce(function (obj, e) {
            _this.pluseOrmindus(obj, e);
        }, 1000);
        _this.other();
        var nav = _this.navParams.get('nav') || {};
        var gamenav = nav;
        _this.gameconfigdata.setPid(gamenav.pid);
        _this.gameconfigdata.fetchMethedsList();
        _this.share.gameId = nav && nav.pid;
        gameconfigdata.getDefaultsMethods();
        gameconfigdata.isInit = true;
        gameconfigdata.getIssues();
        _this.gameinfo.getRecord();
        basket.clearAll();
        _this.menuCtrl.enable(false, 'unauthenticated');
        return _this;
    }
    Pk10Page.prototype.tmpComformMethod = function (a, b, c) {
        this.methodGroup = {
            a: a, b: b, c: c
        };
    };
    Pk10Page.prototype.logDrag = function () {
        this.handler();
    };
    Pk10Page.prototype.ionViewDidLoad = function () {
        this.initEffect();
    };
    Pk10Page.prototype.ionViewWillLeave = function () {
        this.menuCtrl.enable(true, 'unauthenticated');
    };
    Pk10Page.prototype.other = function () {
        var _this = this;
        this.menuCtrl.enable(false, 'unauthenticated');
        clearInterval(this.cccInterval);
        this.cccInterval = setInterval(function () {
            _this.ccc = !_this.ccc;
        }, 800);
    };
    Pk10Page.prototype.setGrounpChoose = function (name, arr, value) {
        this.util.daxiaodanshuangqing(arr, name, value);
    };
    Pk10Page.prototype.comformMethod = function () {
    ...
    Pk10Page.prototype.modeChange = function (obj, mode) {
    ...
    Pk10Page.prototype.restTimesWhenChangeMode = function (obj) {
        if (obj.mutipleAndModeObj.times >= obj.max_multiple) {
            obj.mutipleAndModeObj.times = obj.max_multiple;
        }
    };
    Pk10Page.prototype.messages = function (obj) {
        var hasChoose = this.basket.hasChooseBall(obj.selectarea);
    ...
    Pk10Page.prototype.addBall = function (obj) {
        var isSucess = this.basket.addDataToBasket(obj);
        if (isSucess) {
            this.clear(obj);
            var toast = this.toastCtrl.create({
                message: '注单添加成功',
    ...
    Pk10Page.prototype.goBuybasket = function (obj) {
        var isSucess = this.basket.addDataToBasket(obj);
